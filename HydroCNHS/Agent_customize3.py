...
class DivDM(object):
    def __init__(self, StartDate, DataLength, ABM):
        BasicPath = r"C:\Users\Philip\OneDrive\Lehigh\0_Proj2_UA-SA-Equifinality\YRBModel\INPUT"
        ...
        self.Path = {"FlowTarget": os.path.join(BasicPath, "FlowTarget_Cali.csv"),
                     ...
                     "CCurves": r"C:\Users\Philip\OneDrive\Lehigh\0_Proj2_UA-SA-Equifinality\Data",
...
class IrrDiv_AgType(object):
    def __init__(self, Name, Config, StartDate, DataLength):
        ...
        self.DMClass = Config["Inputs"]["DMClass"]
...
class IrrDiv_RWS_AgType(object):
    def __init__(self, Name, Config, StartDate, DataLength):
        ...
        for ag in self.AgList:
            ...
            #--- DMClass
            self.AgDMClass[ag] = self.AgConfig[ag]["Inputs"]["DMClass"]
            #--- Store space
            Output = pd.DataFrame(index=self.rng, columns=["DailyAction", "RequestDiv", "ActualDiv"])
    ...
    def act(self, Q, AgentDict, node, CurrentDate, t, DMs):
        ...
        DM = DMs[self.AgDMClass[ag]]  # Here they share a DM class.
        MinFlowTarget = 3.53 + DM.IncreaseMinFlow # cms
...
class ResDam_AgType(object):
    ...
    def act(self, Q, AgentDict, node, CurrentDate, t, DMs = None):
        self.Q = Q
